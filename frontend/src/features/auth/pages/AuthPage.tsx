        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans selection:bg-emerald-500/20 selection:text-emerald-900">
            <div className="w-full max-w-md space-y-6 animate-in fade-in zoom-in duration-300">
                ...
                <div className="bento-card p-6 sm:p-8 bg-white shadow-xl space-y-6">
                    ...
                    <div className="grid grid-cols-2 p-1.5 bg-slate-100 rounded-2xl border border-slate-200 text-xs font-semibold">
                        <button
                            type="button"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 text-slate-900 rounded-xl pl-10 pr-4 py-2.5 text-sm font-medium focus:outline-none focus:border-emerald-600"
                                    />
                                </div>
                            </div>
                        )}
                        ...
                        {!isLogin && (
                            <div>
                                <label className="text-xs font-semibold text-slate-700 mb-1 block">Account Type</label>
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        type="button"
                                        onClick={() => setRoleState('user')}
                                        className={`flex items-center justify-center gap-1.5 p-2.5 rounded-xl border text-xs font-semibold transition cursor-pointer ${
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold transition shadow-md shadow-emerald-600/20 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 mt-2"
                        >
                            {loading ? (
                                'Authenticating...'
                            ) : (
